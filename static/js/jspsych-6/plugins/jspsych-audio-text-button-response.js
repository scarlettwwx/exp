...
jsPsych.plugins["audio-text-button-response"] = (function() {

  var plugin = {};

  jsPsych.pluginAPI.registerPreload('audio-text-button-response', 'stimulus', 'audio');

  plugin.info = {
    name: "audio-text-button-response",
    parameters: {
      parameter_name: {
  ...
  plugin.info = {
    ...
    parameters: {
      ...
      stimulus_text: { // ADDED BY ME
        type: jsPsych.plugins.parameterType.STRING,
        pretty_name: 'Corresponding text string to audio stimulus',
        default: undefined,
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // add text string of stimulus on top
    var html='<div id="stimulus_text_string" style="padding:20px"><font size="30">'+trial.stimulus_text;
    html+='</font></div>'
